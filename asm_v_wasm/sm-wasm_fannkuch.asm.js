...
function Ua(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   g = f + 8 | 0;
   h = c[g >> 2] | 0;
   do if ((d | 0) == (h | 0)) c[913] = k & ~(1 << b); else {
    if (h >>> 0 < (c[917] | 0) >>> 0) ba();
    a = h + 12 | 0;
    if ((c[a >> 2] | 0) == (f | 0)) {
     c[a >> 2] = d;
  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[917] | 0) >>> 0) ba(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[915] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (b >>> 0 < (c[917] | 0) >>> 0) ba(); else {
      c[b >> 2] = j;
      c[j + 24 >> 2] = a;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
  ...
  do if (!j) {
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (j | 0)) {
     ...
     if ((w | 0) == 276) if (b >>> 0 < (c[917] | 0) >>> 0) ba(); else {
      c[b >> 2] = l;
      c[l + 24 >> 2] = a;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (j | 0)) {
    ...
    if ((w | 0) == 302) if (b >>> 0 < (c[917] | 0) >>> 0) ba(); else {
     c[b >> 2] = j;
     c[j + 24 >> 2] = a;
     c[j + 12 >> 2] = j;
     c[j + 8 >> 2] = j;
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
      ...
      while (1) {
       ...
       do if (r >>> 0 < s >>> 0) r = s; else {
        ...
        do {
         ...
         o = C;
         A = db(B | 0, o | 0, 1e9, 0) | 0;
         c[r >> 2] = A;
         o = cb(B | 0, o | 0, 1e9, 0) | 0;
         r = r + -4 | 0;
        } while (r >>> 0 >= s >>> 0);
        if (!o) {
         r = s;
     ...
     if (!(f & 32)) Ea(s ? (t ? 3593 : 3597) : t ? 3585 : 3589, 3, e) | 0;
     Ka(e, 32, K, r, I ^ 8192);
     f = (r | 0) < (K | 0) ? K : r;
    } while (0);
    o = f;
...
function Va(a) {
 ...
 do if (!(a & b)) {
  ...
  if ((e | 0) == 127) if (b >>> 0 < (c[917] | 0) >>> 0) ba(); else {
   c[b >> 2] = q;
   c[q + 24 >> 2] = a;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function Qa(b, d) {
 ...
 d = d | 0;
 var e = 0, f = 0, g = 0;
 if ((c[d + 76 >> 2] | 0) < 0) g = 3; else if (!(Pa(d) | 0)) g = 3; else {
...
function wa() {
 var a = 0;
 if (!0) a = 3648; else a = c[(eb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function la(a) {
 a = a | 0;

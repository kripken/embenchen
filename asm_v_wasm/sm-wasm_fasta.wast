(module
  ...
  (export "_i64Subtract" $ib)
  (export "_free" $bb)
  (export "_main" $ya)
  (export "_i64Add" $jb)
  (export "_pthread_self" $rb)
  (export "_memset" $kb)
  (export "___udivdi3" $pb)
  (export "_malloc" $ab)
  (export "_memcpy" $nb)
  (export "_bitshift64Lshr" $lb)
  (export "_bitshift64Shl" $mb)
  (export "___uremdi3" $qb)
  (export "___errno_location" $Ca)
  (export "___udivmoddi4" $ob)
  (export "runPostSets" $hb)
  ...
  (export "dynCall_ii" $sb)
  (export "dynCall_iiii" $tb)
  (export "dynCall_vi" $ub)
  (export "dynCall_v" $vb)
  (table $wb $Aa $xb $Ha $Ga $Da $yb $Ea $zb)
  (func $ab (param $a i32) (result i32)
    (local $b i32)
    (local $d i32)
    (local $e i32)
    (local $f i32)
  ...
  (func $ob (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32) (result i32)
    (local $g i32)
    (local $h i32)
    (local $i i32)
    (local $j i32)
  ...
  (func $ya (param $b i32) (param $d i32) (result i32)
    (local $e f64)
    (local $f i32)
    (local $h i32)
    (local $j i32)
  ...
  (func $za (param $b i32) (param $d i32)
    (local $e i32)
    (local $f i32)
    (local $h f64)
    (if
  ...
  (func $Xa (param $b i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (local $h i32)
    (local $j i32)
  ...
  (func $nb (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (if
      (i32.ge_s
        (get_local $e)
  ...
  (func $Ya (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $f
      (i32.mul
  ...
  (func $wb (param $a i32) (result i32)
    (call_import $U
      (i32.const 0)
    )
    (return

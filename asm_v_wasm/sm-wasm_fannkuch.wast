(module
  ...
  (func $bb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32) (result i32)
    (local $g i32)
    (local $h i32)
    (local $i i32)
    (local $j i32)
  ...
  (func $Qa (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $f i32)
    (local $g i32)
    (if
  ...
  (func $Za (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (local $h i32)
    (local $i i32)
  ...
  (func $db (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $g
      (i32.load
  ...
  (func $$a (param $a i32) (param $b i32) (param $c i32) (result i32)
    (if
      (i32.lt_s
        (get_local $c)
        (i32.const 32)
  ...
  (func $_a (param $a i32) (param $b i32) (param $c i32) (result i32)
    (if
      (i32.lt_s
        (get_local $c)
        (i32.const 32)
  ...
  (func $Xa (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $d
      (i32.sub
        (i32.sub
          (get_local $b)
  ...
  (func $Sa (param $a i32) (param $b i32) (result i32)
    (local $d i32)
    (local $e i32)
    (set_local $d
      (i32.load
  ...
  (func $Ya (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $c
      (i32.add
        (get_local $a)
        (get_local $c)
  ...
  (func $hb (param $a i32) (param $b i32)
  ...
  (func $ib (param $a i32) (result i32)
    (call_import $U
      (i32.const 0)
    )
    (return

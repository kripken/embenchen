(module
  ...
  (export "_i64Subtract" $Ta)
  (export "_free" $Ra)
  (export "_main" $sa)
  (export "_i64Add" $Ua)
  (export "_pthread_self" $ab)
  (export "_memset" $Va)
  (export "___udivdi3" $_a)
  (export "_malloc" $Qa)
  (export "_memcpy" $Ya)
  (export "_bitshift64Lshr" $Wa)
  (export "_bitshift64Shl" $Xa)
  (export "___uremdi3" $$a)
  (export "___errno_location" $va)
  (export "___udivmoddi4" $Za)
  (export "runPostSets" $Sa)
  ...
  (table $eb $ta $fb $Aa $za $wa $gb $xa)
  (func $Qa (param $a i32) (result i32)
    (local $b i32)
    (local $d i32)
    (local $e i32)
    (local $f i32)
  ...
  (func $Ca (param $e i32) (param $f i32) (param $g i32) (param $j i32) (param $l i32) (result i32)
    (local $m i32)
    (local $n i32)
    (local $o i32)
    (local $p i32)
  ...
  (func $Za (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32) (result i32)
    (local $g i32)
    (local $h i32)
    (local $i i32)
    (local $j i32)
  ...
  (func $Fa (param $a i32) (param $b i32) (param $d i32)
    (local $e i32)
    (local $f i32)
    (local $g f64)
    (block $label$break$a
  ...
  (func $wa (param $a i32) (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $f i32)
    (local $g i32)
    (local $h i32)
  ...
  (func $sa (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $f i32)
    (local $g i32)
    (local $h i32)
  ...
  (func $Da (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (local $h i32)
    (local $i i32)
  ...
  (func $La (param $b i32) (param $d i32) (param $e i32) (result i32)
    (block $do-once$0
      (if
        (i32.eqz
          (get_local $b)
  ...
  (func $Ja (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32)
    (local $g i32)
    (local $h i32)
    (local $j i32)
    (set_local $j
  ...
  (func $Ga (param $b i32) (param $c i32) (param $d i32) (result i32)
    (local $e i32)
    (if
      (i32.or
        (i32.gt_u
  ...
  (func $Ha (param $b i32) (result i32)
    (local $c i32)
    (local $e i32)
    (set_local $c
      (i32.const 0)
  ...
  (func $Ea (param $b i32) (result i32)
    (local $d i32)
    (local $e i32)
    (set_local $d
      (i32.add
  ...
  (func $Aa (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $g
      (i32.load
  ...
  (func $$a (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $g
      (i32.load
  ...
  (func $Xa (param $a i32) (param $b i32) (param $c i32) (result i32)
    (if
      (i32.lt_s
        (get_local $c)
        (i32.const 32)
  ...
  (func $Ta (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $d
      (i32.sub
        (i32.sub
          (get_local $b)
  ...
  (func $Pa (param $a i32) (param $b i32) (result i32)
    (local $d i32)
    (local $e i32)
    (set_local $d
      (i32.load
  ...
  (func $ta (param $a i32) (result i32)
    (local $b i32)
    (local $d i32)
    (set_local $b
      (i32.load
  ...
  (func $Ua (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $c
      (i32.add
        (get_local $a)
        (get_local $c)
  ...
  (func $Ka (param $a i32) (param $b i32) (result i32)
    (if
      (i32.eqz
        (get_local $a)
      )
  ...
  (func $Ma (param $a f64) (param $b i32) (result f64)
    (return
      (call $Na
        (get_local $a)
        (get_local $b)

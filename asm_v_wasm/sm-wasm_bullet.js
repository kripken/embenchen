function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "sm-wasm_bullet.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "sm-wasm_bullet.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "sm-wasm_bullet.asm.js";
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "sm-wasm_bullet.js.mem" : null;
...
Module.asmLibraryArg = {
 ...
 "invoke_viiiifffffif": invoke_viiiifffffif,
 ...
 "invoke_fiiiiiiiiiii": invoke_fiiiiiiiiiii,

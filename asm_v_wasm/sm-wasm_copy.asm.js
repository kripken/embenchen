  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if (!(f & 32)) Da(s ? (t ? 3576 : 3580) : t ? 3568 : 3572, 3, e) | 0;
     Ja(e, 32, K, r, I ^ 8192);
     f = (r | 0) < (K | 0) ? K : r;
    } while (0);
    o = f;
...
function sa(b, d) {
 ...
 do {
  ...
  j = (k | 0) % 255 | 0;
  f = (k | 0) % 15 | 0;
  g = ((k | 0) % 120 | 0 | 0) % 1024 | 0;
  d = ((k | 0) % 1024 | 0) + k | 0;
  e = ((e | 0) % 1024 | 0) + e | 0;
  f = ((f | 0) % 1024 | 0) + f | 0;
  g = ((((j | 0) % 1024 | 0) + j + g | 0) % 1024 | 0) + g | 0;
  j = 0;
  do {
   r = j << 1;
   t = (j | 0) % 120 | 0;
   p = (r | 0) % 1024 | 0;
   o = (j + h | 0) % 1024 | 0;
   q = ((j | 0) % 255 | 0 | 0) % 1024 | 0;
   u = (j | 0) % 1024 | 0;
   s = ((j | 0) % 15 | 0 | 0) % 1024 | 0;
   b = (((g + u + s + q + p + o + ((f + u | 0) % 1024 | 0) + ((((t | 0) % 1024 | 0) + t + s | 0) % 1024 | 0) + ((p + r + q | 0) % 1024 | 0) + ((e + p | 0) % 1024 | 0) + ((d + o | 0) % 1024 | 0) | 0) % 100 | 0) + b | 0) % 10240 | 0;
   j = j + 1 | 0;
  } while ((j | 0) != 5e4);
  k = k + 1 | 0;
 } while ((k | 0) < (l | 0));
...
function va() {
 var a = 0;
 if (!0) a = 3632; else a = c[(ab() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function la(a) {
 a = a | 0;

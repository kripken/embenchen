  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[913] | 0) >>> 0) ba(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[911] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (b >>> 0 < (c[913] | 0) >>> 0) ba(); else {
      c[b >> 2] = j;
      c[j + 24 >> 2] = a;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
  ...
  do if (!j) {
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (j | 0)) {
     ...
     if ((w | 0) == 276) if (b >>> 0 < (c[913] | 0) >>> 0) ba(); else {
      c[b >> 2] = l;
      c[l + 24 >> 2] = a;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (j | 0)) {
    ...
    if ((w | 0) == 302) if (b >>> 0 < (c[913] | 0) >>> 0) ba(); else {
     c[b >> 2] = j;
     c[j + 24 >> 2] = a;
     c[j + 12 >> 2] = j;
     c[j + 8 >> 2] = j;
...
function Da(e, f, g, j, l) {
 ...
 a : while (1) {
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if ((D | 0) == 97) {
      ...
      r = s + w | 0;
      Ka(e, 32, K, r, I);
      if (!(c[e >> 2] & 32)) Ea(y, w, e) | 0;
      Ka(e, 48, K, r, I ^ 65536);
      o = f - Z | 0;
      if (!(c[e >> 2] & 32)) Ea(ea, o, e) | 0;
      f = ba - p | 0;
      Ka(e, 48, s - (o + f) | 0, 0, 0);
      if (!(c[e >> 2] & 32)) Ea(t, f, e) | 0;
      Ka(e, 32, K, r, I ^ 8192);
      f = (r | 0) < (K | 0) ? K : r;
      break;
     }
     ...
     if ((o | 0) > 0) {
      ...
      while (1) {
       ...
       do if (r >>> 0 < s >>> 0) r = s; else {
        o = 0;
        do {
         B = bb(c[r >> 2] | 0, 0, t | 0) | 0;
         B = _a(B | 0, C | 0, o | 0, 0) | 0;
         o = C;
         A = fb(B | 0, o | 0, 1e9, 0) | 0;
         c[r >> 2] = A;
         o = eb(B | 0, o | 0, 1e9, 0) | 0;
         r = r + -4 | 0;
        } while (r >>> 0 >= s >>> 0);
        if (!o) {
         r = s;
     ...
     do if (t) {
      ...
      if ((f | 0) > 0 & o >>> 0 < D >>> 0) {
       ...
       while (1) {
        ...
        if (!(c[e >> 2] & 32)) Ea(o, (f | 0) > 9 ? 9 : f, e) | 0;
        p = p + 4 | 0;
        o = f + -9 | 0;
        if (!((f | 0) > 9 & p >>> 0 < D >>> 0)) {
         f = o;
      ...
      if ((f | 0) > -1) {
       ...
       do {
        ...
        p = U - o | 0;
        if (!(c[e >> 2] & 32)) Ea(o, (f | 0) > (p | 0) ? p : f, e) | 0;
        f = f - p | 0;
        r = r + 4 | 0;
       } while (r >>> 0 < t >>> 0 & (f | 0) > -1);
      }
     ...
     if (!(f & 32)) Ea(s ? (t ? 3571 : 3575) : t ? 3563 : 3567, 3, e) | 0;
     Ka(e, 32, K, r, I ^ 8192);
     f = (r | 0) < (K | 0) ? K : r;
    } while (0);
    o = f;
  ...
  o = (K | 0) < (s | 0) ? s : K;
  Ka(e, 32, o, s, p);
  if (!(c[e >> 2] & 32)) Ea(v, w, e) | 0;
  Ka(e, 48, o, s, p ^ 65536);
  Ka(e, 48, r, t, 0);
  if (!(c[e >> 2] & 32)) Ea(f, t, e) | 0;
  Ka(e, 32, o, s, p ^ 8192);
  y = J;
 }
...
function Xa(a) {
 ...
 do if (!(a & b)) {
  ...
  if ((e | 0) == 127) if (b >>> 0 < (c[913] | 0) >>> 0) ba(); else {
   c[b >> 2] = q;
   c[q + 24 >> 2] = a;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function db(a, b, d, e, f) {
 ...
 if (!h) {
  ...
  do {
   ...
   e = a << 1 | e >>> 31 | 0;
   n = a >>> 31 | b << 1 | 0;
   Za(k | 0, d | 0, e | 0, n | 0) | 0;
   p = C;
   o = p >> 31 | ((p | 0) < 0 ? -1 : 0) << 1;
   i = o & 1;
   a = Za(e | 0, n | 0, o & m | 0, (((p | 0) < 0 ? -1 : 0) >> 31 | ((p | 0) < 0 ? -1 : 0) << 1) & l | 0) | 0;
   b = C;
   h = h - 1 | 0;
  } while ((h | 0) != 0);
  k = j;
...
function Ca(b, d, e) {
 ...
 c[o >> 2] = c[e >> 2];
 if ((Da(0, d, o, q, r) | 0) < 0) e = -1; else {
  if ((c[b + 76 >> 2] | 0) > -1) m = Pa(b) | 0; else m = 0;
  e = c[b >> 2] | 0;
  n = e & 32;
...
function ta(b, d) {
 ...
 do {
  d = 0;
  do {
   if (!(sa() | 0)) g = 15; else if (!(sa() | 0)) g = 15; else b = b + 17 | 0;
   if ((g | 0) == 15) {
    g = 0;
    b = b + 19 | 0;
   }
...
function Ra(b, e) {
 ...
 do if ((h | 0) == 4) {
  ...
  if ((ja[c[b + 36 >> 2] & 3](b, l, 1) | 0) == 1) f = d[l >> 0] | 0; else f = -1;
 } while (0);
 i = m;
 return f | 0;
}
...
function Va(b) {
 ...
 var d = 0, e = 0, f = 0;
 e = c[256] | 0;
 if ((c[e + 76 >> 2] | 0) > -1) f = Pa(e) | 0; else f = 0;
 do if ((Ta(b, e) | 0) < 0) b = 1; else {
  if ((a[e + 75 >> 0] | 0) != 10) {
   b = e + 20 | 0;
   d = c[b >> 2] | 0;
   if (d >>> 0 < (c[e + 16 >> 2] | 0) >>> 0) {
...
function La(a, b) {
 a = a | 0;
 b = b | 0;
 if (!a) a = 0; else a = Ma(a, b, 0) | 0;
 return a | 0;
}

function wa() {
 var a = 0;
 if (!0) a = 3632; else a = c[(gb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function la(a) {
 a = a | 0;

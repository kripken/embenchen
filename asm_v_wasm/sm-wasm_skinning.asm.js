  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[913] | 0) >>> 0) da(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[911] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (b >>> 0 < (c[913] | 0) >>> 0) da(); else {
      c[b >> 2] = j;
      c[j + 24 >> 2] = a;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
  ...
  do if (!j) {
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (j | 0)) {
     ...
     if ((w | 0) == 276) if (b >>> 0 < (c[913] | 0) >>> 0) da(); else {
      c[b >> 2] = l;
      c[l + 24 >> 2] = a;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (j | 0)) {
    ...
    if ((w | 0) == 302) if (b >>> 0 < (c[913] | 0) >>> 0) da(); else {
     c[b >> 2] = j;
     c[j + 24 >> 2] = a;
     c[j + 12 >> 2] = j;
     c[j + 8 >> 2] = j;
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if ((o | 0) > 0) {
      ...
      while (1) {
       ...
       do if (r >>> 0 < s >>> 0) r = s; else {
        o = 0;
        do {
         B = fb(c[r >> 2] | 0, 0, t | 0) | 0;
         B = cb(B | 0, C | 0, o | 0, 0) | 0;
         o = C;
         A = jb(B | 0, o | 0, 1e9, 0) | 0;
         c[r >> 2] = A;
         o = ib(B | 0, o | 0, 1e9, 0) | 0;
         r = r + -4 | 0;
        } while (r >>> 0 >= s >>> 0);
        if (!o) {
         r = s;
     ...
     if (!(f & 32)) Ka(s ? (t ? 3577 : 3581) : t ? 3569 : 3573, 3, e) | 0;
     Qa(e, 32, K, r, I ^ 8192);
     f = (r | 0) < (K | 0) ? K : r;
    } while (0);
    o = f;
...
function Ya(a) {
 ...
 do if (!(a & b)) {
  ...
  if ((e | 0) == 127) if (b >>> 0 < (c[913] | 0) >>> 0) da(); else {
   c[b >> 2] = q;
   c[q + 24 >> 2] = a;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function za(b, d) {
 b = b | 0;
 d = d | 0;
 var e = 0.0, f = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0;
 q = i;
 i = i + 64 | 0;
 p = q + 8 | 0;
 f = q;
 ...
 e = 0.0;
 do {
  e = e + (+g[f + (b << 4) >> 2] + +g[f + (b << 4) + 4 >> 2] + +g[f + (b << 4) + 8 >> 2] + +g[f + (b << 4) + 12 >> 2]);
  b = b + 1 | 0;
 } while ((b | 0) != (k | 0));
 h[p >> 3] = e;
 Wa(1152, p) | 0;
...
function ya(a, b, d, e, f) {
 ...
 e = e | 0;
 f = f | 0;
 var h = 0.0, i = 0, j = 0.0, k = 0.0, l = 0.0, m = 0.0, n = 0.0, o = 0.0, p = 0.0, q = 0.0, r = 0.0, s = 0.0, t = 0.0, u = 0, v = 0.0, w = 0.0;
 if (!b) return;
 while (1) {
  b = b + -1 | 0;
  i = c[e >> 2] | 0;
  ...
  j = j * +g[a + (i * 48 | 0) + 44 >> 2];
  i = e + 12 | 0;
  if (!(c[e + 8 >> 2] | 0)) while (1) {
   u = c[i >> 2] | 0;
   v = +g[e + 16 >> 2];
   k = k + v * +g[a + (u * 48 | 0) >> 2];
   h = h + v * +g[a + (u * 48 | 0) + 4 >> 2];
   m = m + v * +g[a + (u * 48 | 0) + 8 >> 2];
   o = o + v * +g[a + (u * 48 | 0) + 12 >> 2];
   q = q + v * +g[a + (u * 48 | 0) + 16 >> 2];
   s = s + v * +g[a + (u * 48 | 0) + 20 >> 2];
   t = t + v * +g[a + (u * 48 | 0) + 24 >> 2];
   r = r + v * +g[a + (u * 48 | 0) + 28 >> 2];
   p = p + v * +g[a + (u * 48 | 0) + 32 >> 2];
   n = n + v * +g[a + (u * 48 | 0) + 36 >> 2];
   l = l + v * +g[a + (u * 48 | 0) + 40 >> 2];
   j = j + v * +g[a + (u * 48 | 0) + 44 >> 2];
   e = i + 12 | 0;
   if (!(c[i + 8 >> 2] | 0)) {
    u = i;
    i = e;
  ...
  w = +g[i >> 2];
  v = +g[d + 8 >> 2];
  g[f >> 2] = o + (k * +g[d >> 2] + h * w + m * v);
  o = +g[d >> 2];
  g[f + 4 >> 2] = r + (t * v + (s * w + q * o));
  g[f + 8 >> 2] = j + (l * v + (p * o + n * +g[i >> 2]));
  i = d + 16 | 0;
  u = d + 20 | 0;
  o = +g[u >> 2];
  r = +g[d + 24 >> 2];
  g[f + 16 >> 2] = k * +g[i >> 2] + h * o + m * r;
  v = +g[i >> 2];
  g[f + 20 >> 2] = t * r + (s * o + q * v);
  g[f + 24 >> 2] = l * r + (p * v + n * +g[u >> 2]);
  if (!b) break; else {
   d = d + 32 | 0;
   f = f + 32 | 0;
  }
...
function Ca() {
 var a = 0;
 if (!0) a = 3632; else a = c[(kb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function ra(a) {
 a = a | 0;

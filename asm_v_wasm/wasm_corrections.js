...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || "wasm_corrections.wast";
  var wasmBinaryFile = Module['wasmBinaryFile'] || "wasm_corrections.wasm";
  var asmjsCodeFile = Module['asmjsCodeFile'] || "wasm_corrections.asm.js";
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm_corrections.js.mem" : null;

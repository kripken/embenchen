  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if (!(f & 32)) Da(s ? (t ? 3575 : 3579) : t ? 3567 : 3571, 3, e) | 0;
     Ja(e, 32, K, r, I ^ 8192);
     f = (r | 0) < (K | 0) ? K : r;
    } while (0);
    o = f;
...
function sa(b, d) {
 ...
 do {
  ...
  do {
   f = b + 2 | 0;
   k = (((((R(f, b) | 0) + 17 | 0) % 5 | 0 | 0) == 0 ? 1 : ((((R(b, b) | 0) + 11 | 0) >>> 0) % 3 | 0 | 0) == 0) | 0) == 0;
   b = k ? b + 1 | 0 : f;
   d = d + 1 | 0;
  } while ((d | 0) < (g | 0));
  e = e + 1 | 0;

...
function Qa(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   g = f + 8 | 0;
   h = c[g >> 2] | 0;
   do if ((d | 0) == (h | 0)) c[911] = k & ~(1 << b); else {
    if (h >>> 0 < (c[915] | 0) >>> 0) ba();
    a = h + 12 | 0;
    if ((c[a >> 2] | 0) == (f | 0)) {
     c[a >> 2] = d;
  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[915] | 0) >>> 0) ba(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[913] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (b >>> 0 < (c[915] | 0) >>> 0) ba(); else {
      c[b >> 2] = j;
      c[j + 24 >> 2] = a;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
 ...
 if ((w | 0) == 191) {
  a = (c[1019] | 0) + h | 0;
  c[1019] = a;
  if (a >>> 0 > (c[1020] | 0) >>> 0) c[1020] = a;
  j = c[917] | 0;
  do if (!j) {
   C = c[915] | 0;
   if ((C | 0) == 0 | f >>> 0 < C >>> 0) c[915] = f;
   c[1023] = f;
   c[1024] = h;
   c[1026] = 0;
   c[920] = c[1029];
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (j | 0)) {
     ...
     if ((w | 0) == 276) if (b >>> 0 < (c[915] | 0) >>> 0) ba(); else {
      c[b >> 2] = l;
      c[l + 24 >> 2] = a;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (j | 0)) {
    ...
    if ((w | 0) == 302) if (b >>> 0 < (c[915] | 0) >>> 0) ba(); else {
     c[b >> 2] = j;
     c[j + 24 >> 2] = a;
     c[j + 12 >> 2] = j;
     c[j + 8 >> 2] = j;
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if (!(f & 32)) Da(s ? (t ? 3583 : 3587) : t ? 3575 : 3579, 3, e) | 0;
     Ja(e, 32, K, r, I ^ 8192);
     f = (r | 0) < (K | 0) ? K : r;
    } while (0);
    o = f;
...
function Ra(a) {
 ...
 do if (!(a & b)) {
  ...
  if ((e | 0) == 127) if (b >>> 0 < (c[915] | 0) >>> 0) ba(); else {
   c[b >> 2] = q;
   c[q + 24 >> 2] = a;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function sa(b, d) {
 ...
 while (1) {
  ...
  while (1) {
   d = ((h | 0) / (j | 0) | 0) + d | 0;
   if (d >>> 0 > 1e3) d = (d >>> 0) / (k >>> 0) | 0;
   if (!(h & 3)) d = d + (R((h & 7 | 0) == 0 ? 1 : -1, h) | 0) | 0;
   e = d << 16 >> 16;
   e = (R(e, e) | 0) & 255;
   g = e + (b & 65535) | 0;
   h = h + 1 | 0;
   if ((h | 0) == 2e4) break; else b = g;
  }
  f = f + 1 | 0;
  if ((f | 0) < (l | 0)) b = g; else break;
 }
 c[m >> 2] = d;
 c[m + 4 >> 2] = b + e & 65535;
 Pa(1152, m) | 0;
...
function va() {
 var a = 0;
 if (!0) a = 3640; else a = c[(ab() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function la(a) {
 a = a | 0;
